...
public class QuizMain {
	...
	public static void main(String[] args) {
		...
		try {
			fis = new FileInputStream("C:\\Users\\yong\\Desktop\\java_web_yong\\주택도시보증공사_전국 평균 분양가격(2020년 2월).csv");
			...
			try {
				while((str = br.readLine()) != null) {
					String[] arr = str.split(",");//분할하는 것 split
//					System.out.println(Arrays.toString(arr));
				...
				//똑같이 data로 써도 되지만 다른 price는 구분지어서 써도 된다.
				List<Data> newList = 
				...
				&& Interger.parseInt(data.getprice()) >= 4000)
				.collect(Collectors.toList());
				*/
