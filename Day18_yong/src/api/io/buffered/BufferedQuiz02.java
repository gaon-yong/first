...
public class BufferedQuiz02 {
	...
	public static void main(String[] args) {
		...
		File file = new File("C:\\Users\\yong\\Desktop\\java_web_yong\\file\\" + today + "file");
		...
		try {
			bw = 
				new BufferedWriter(new FileWriter("C:\\Users\\yong\\Desktop\\java_web_yong\\file\\" + today + "file\\" + str + ".txt"));
		...
		try {
			fr = new FileReader("C:\\Users\\yong\\Desktop\\java_web_yong\\file\\" + today + "file\\" + str + ".txt");
