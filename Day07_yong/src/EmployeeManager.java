	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(menu == 1) {
				...
				//사번 입력-> 존재하는 사번이 맞다면 -> [1. 나이변경 | 2.부서 변경 |3.취소]
				//사번이 존재하지 않는다면 없다고 얘기해주세요.
					...
					if(empNum.equals(userNums[i])) {
						...
						int select = sc.nextInt();
						 ...
						 case 2:
							 ...
							 System.out.printf("부서가 %d로 정상 변경되었습니다.\n", departments[i]);
							 break;
						 case 3:
