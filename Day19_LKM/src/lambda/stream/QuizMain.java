...
public class QuizMain {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 4. 람다식을 이용해서 지역: 서울, 월: 짝수 의 분양가격이 
		 4000 이상의 객체만 뽑아서 새로운 list를 생성. (filter)
...
//		FileReader fr = null;
		...
		try {
			fis = new FileInputStream("C:\\Users\\admin\\Desktop\\Java_Web_LKM\\주택도시보증공사_전국 평균 분양가격(2020년 2월).csv");
