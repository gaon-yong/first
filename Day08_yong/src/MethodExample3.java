...
/*
 ...
 4. return이라는 키워드를 사용하며 return 뒤에 전달할 값을 
  ...
  7. 이 때는 반환유형을 메서드를 선언할 대 비워두지 마시고
  void라는 키워드를 작성해 주셔야 합니다.
  
  8. 모든 메서드는 return을 만나면 강제로 메서드가 종료됩니다.
  따라서 조건 없이 return문 아래에 코드를 작성하실 수 없습니다.
...
//		return new int[] {add(n1,n2), n1-n2, n1*n2, n1/n2};
	...
	public static void main(String[] args) {
		...
		int r3 = add(add(4,6), add(7,8));//설명문 5번엔 관한 설명
...
//		System.out.println(multi(10,7)); (x)
		multi(10, 7);// <- 단독호출 //int r4 = multi(10,7); (x)
		multi(add(3,4), add(4,7));// = multi(7,11);
//		add(multi(4,4), multi(5,6)); (x) multi에서 리턴값이 없기때문에 안됨
