	...
	public static void main(String[] args) {
		...
		/*
		 - Calculator 클래스에 calcRectArea() 메서드를 선언하여
		  ...
		  (길이가 5인 정사각형의 넓이, 가로 10 세로20인 직사각형
		  윗변 5 밑변 13 높이 7인 사리꼴의 넓이)
		  
		  
		 */
		Calculator c = new Calculator();// 객체를 정의하지 않으면 메서드가 안된다!!
		
		System.out.println("정사각형의 넓이:" + c.calcRectArea(5));
		System.out.println("직사각형의 넓이:" + c.calcRectArea(10, 20));
		System.out.println("사디리꼴의 넓이:" + c.calcRectArea(5, 13 , 7));
