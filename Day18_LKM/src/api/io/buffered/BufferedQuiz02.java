...
public class BufferedQuiz02 {
	...
	public static void main(String[] args) {
		...
		File file = new File("C:\\Users\\admin\\Desktop\\Java_Web_LKM\\file\\" + today + "file");
		...
		try {
			bw = 
					new BufferedWriter(new FileWriter("C:\\Users\\admin\\Desktop\\Java_Web_LKM\\file\\" + today + "file\\" + str + ".txt"));
